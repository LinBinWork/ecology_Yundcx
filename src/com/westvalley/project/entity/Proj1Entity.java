...
public class Proj1Entity {
    ...
    /**项目拆解冻结金额*/
    private double projSplitFreezeAmt;
    /**项目拆解归档金额*/
    private double projSplitUsedAmt;
    /**项目可拆解金额*/
    private double projCanSplitAmt;
    /**项目剩余金额*/
     ...
     * 获取 项目可拆解金额
     *
     * @return projCanSplitAmt 项目可拆解金额
     */
    public double getProjCanSplitAmt() {
        return this.projCanSplitAmt;
    }

    /**
     * 设置 项目可拆解金额
     *
     * @param projCanSplitAmt 项目可拆解金额
     */
    public void setProjCanSplitAmt(double projCanSplitAmt) {
        this.projCanSplitAmt = projCanSplitAmt;
    }

    /**
     * 获取 项目拆解冻结金额
     *
     * @return projSplitFreezeAmt 项目拆解冻结金额
     */
    public double getProjSplitFreezeAmt() {
        return this.projSplitFreezeAmt;
    }

    /**
     * 设置 项目拆解冻结金额
     *
     * @param projSplitFreezeAmt 项目拆解冻结金额
     */
    public void setProjSplitFreezeAmt(double projSplitFreezeAmt) {
        this.projSplitFreezeAmt = projSplitFreezeAmt;
    }

    /**
     * 获取 项目拆解归档金额
     *
     * @return projSplitUsedAmt 项目拆解归档金额
     */
    public double getProjSplitUsedAmt() {
        return this.projSplitUsedAmt;
    }

    /**
     * 设置 项目拆解归档金额
     *
     * @param projSplitUsedAmt 项目拆解归档金额
     */
    public void setProjSplitUsedAmt(double projSplitUsedAmt) {
        this.projSplitUsedAmt = projSplitUsedAmt;
    }
