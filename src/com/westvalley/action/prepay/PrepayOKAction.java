 ...
 * 预付款归档
 */
public class PrepayOKAction extends DevAbstractAction{
    ...
    protected ResultDto runCode(RequestInfo info, ActionDto actionDto) {
        ...
        return contractService.contractBudget(contractRequestID,requestID,0,contractList, BudTypeEnum.CONTRACT_USED);
    }
    ...
    public List<ContractDto> getContractList(String requestID,Map<String, String> mainMap){
        ...
        for (Map<String, String> map : wfDetail1) {
            ...
            dto.setUseType(BudTypeEnum.CONTRACT_USED);
